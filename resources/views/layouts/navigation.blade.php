<nav x-data="{ open: false }" class="bg-backdrop-dark border-b border-backdrop-inv">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                        ...
                        <x-application-logo href="/dashboard" />

                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    {{-- {{auth()->user()->can('permission list')?'y':'n';}} --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('permission.index')" :active="request()->routeIs('permission.index')">
                            {{ __('Permissions') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('document')" :active="request()->routeIs('document.index')">
                {{ __('Document') }}
            </x-responsive-nav-link>
        </div>
