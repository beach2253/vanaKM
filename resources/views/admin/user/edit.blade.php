            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="w-full px-6 py-4 bg-white overflow-hidden">
                    ...
                    @method('PUT')
                        ...
                        <div class="py-2">
                            <label for="firstName"
                            class="block font-medium text-sm text-gray-700{{$errors->has('firstName') ? ' text-red-400' : ''}}">
                            {{ __('First Name') }}</label>

                            <input id="firstName"
                                class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('firstName') ? ' border-red-400' : ''}}"
                                            type="text"
                                            name="firstName"
                        ...
                        <div class="py-2">
                            <label for="lastName"
                            class="block font-medium text-sm text-gray-700{{$errors->has('lastName') ? ' text-red-400' : ''}}">
                            {{ __('Last Name') }}</label>

                            <input id="lastName"
                                class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('lastName') ? ' border-red-400' : ''}}"
                                            type="text"
                                            name="lastName"
                        ...
                        <div class="py-2">
                            <label for="staffID"
                            class="block font-medium text-sm text-gray-700{{$errors->has('staffID') ? ' text-red-400' : ''}}">
                            {{ __('Staff ID') }}</label>

                            <input id="staffID"
                                class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('staffID') ? ' border-red-400' : ''}}"
                                            type="text"
                                            name="staffID"
                                            value="{{ old('staffID', $user->staff_id) }}"
                                            />
                        </div>

                        <div class="py-2">
                            <label for="department"
                            class="block font-medium text-sm text-gray-700{{$errors->has('department') ? ' text-red-400' : ''}}">
                            {{ __('Department') }}</label>

                            <input id="department"
                                class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('department') ? ' border-red-400' : ''}}"
                                            type="text"
                                            name="department"
