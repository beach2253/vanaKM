        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="w-full px-6 py-4 bg-white overflow-hidden">
                    ...
                    <div class="py-2">
                        <label for="firstname" class="block font-medium text-sm text-gray-700{{$errors->has('firstname') ? ' text-red-400' : ''}}">
                            {{ __('First Name') }}</label>

                        <input id="firstname" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('firstname') ? ' border-red-400' : ''}}"
                                        type="text"
                                        name="firstname"
                                        value="{{ old('firstname') }}"
                                        />
                    ...
                    <div class="py-2">
                        <label for="lastname" class="block font-medium text-sm text-gray-700{{$errors->has('lastname') ? ' text-red-400' : ''}}">
                            {{ __('Last Name') }}</label>

                        <input id="lastname" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('lastname') ? ' border-red-400' : ''}}"
                                        type="text"
                                        name="lastname"
                                        value="{{ old('lastname') }}"
                                        />
