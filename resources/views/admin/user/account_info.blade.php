        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="w-full px-6 py-4 bg-white overflow-hidden">
                    ...
                    <div class="py-2">
                        <label for="lastname" class="block font-medium text-sm text-gray-700{{$errors->account->has('lastname') ? ' text-red-400' : ''}}">{{ __('lastname') }}</label>

                        <input id="lastname" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->account->has('lastname') ? ' border-red-400' : ''}}"
                                        type="text"
                                        name="lastname"
                    ...
                    <div class="py-2">
                        <label for="firstname" class="block font-medium text-sm text-gray-700{{$errors->account->has('firstname') ? ' text-red-400' : ''}}">{{ __('firstname') }}</label>

                        <input id="firstname" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->account->has('firstname') ? ' border-red-400' : ''}}"
                                        type="text"
                                        name="firstname"
