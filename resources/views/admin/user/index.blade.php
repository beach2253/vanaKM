<x-app-layout>
    ...
    <div class="py-12 bg-backdrop">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-backdrop-dark overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-backdrop-light border-b border-gray-200">
                        ...
                        @endif
                            <div class="min-w-full border-b border-gray-200 shadow overflow-x-auto">
                                ...
                                <table class="border-collapse table-auto w-full text-sm">
                                    ...
                                    <tbody class="bg-backdrop dark:bg-slate-800">
